...
- La ingesta dispone de fuentes, ejecuciones, staging, normalización y
  deduplicación. Hay 18 fuentes piloto registradas y cinco operativas: La Riviera,
  Siroco, Sala Apolo, Sala El Sol y Razzmatazz. Los parsers oficiales han publicado
  99 conciertos, 4 salas y 96 artistas; las otras 13 fuentes siguen pendientes de
...
- TypeScript, lint, 32 pruebas unitarias, 6 smoke tests E2E responsive, build de
